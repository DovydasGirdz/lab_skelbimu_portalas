...
const controller_sign_out = async function (req, res)
{
    ...
    try
    {
        ...
        const result_of_resolve_username = await resolve_username(identification_token)

        // model_users_update

        await model_users_update(
            {
                username: result_of_resolve_username
            },
            {
...
const validate_inputs = function (identification_token)
{
